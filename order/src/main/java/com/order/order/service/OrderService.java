...
public class OrderService {
    ...
    private final WebClient proudctWebClient;
    ...
    public OrderService(WebClient inventoryWebClient, WebClient proudctWebClient, OrderRepo orderRepo, ModelMapper modelMapper) {
        this.inventoryWebClient = inventoryWebClient;
        this.proudctWebClient = proudctWebClient;
    ...
    public OrderResponse saveOrder(OrderDTO OrderDTO) {
        ...
        try{
            ...
            ProductDTO productResponse = proudctWebClient.get()
